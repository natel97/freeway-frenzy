...
public class Bus extends Destroyable {
    ...
    public Bus(int x, int y, Direction dir, ConcurrentLinkedQueue<GameObject> these, GlobalVars globalVars) {
        super(x, y, new Texture("car_red.png"), 128, 256, 300, 4, dir, these, globalVars);
    }
