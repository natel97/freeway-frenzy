...
public class Truck extends Destroyable {
    ...
    public Truck(int x, int y, Direction dir, ConcurrentLinkedQueue<GameObject> these, GlobalVars globalVars) {
        super(x, y, new Texture("truck_red.png"), 128, 256, 120, 5, dir, these, globalVars);
