...
public class Van extends Destroyable {
    ...
    public Van(int x, int y, Direction dir, ConcurrentLinkedQueue<GameObject> these, GlobalVars globalVars) {
        super(x, y, new Texture("car_red.png"), 128, 256, 150, 5, dir, these, globalVars);
    }
